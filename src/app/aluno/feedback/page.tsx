  ...
  return (
    <div style={{ minHeight: "100dvh", background: "#FEE9D6", fontFamily: "var(--font-sans), 'Figtree', system-ui, sans-serif" }}>
      <div style={{ background: "#EB4200", padding: "13px 20px", position: "sticky", top: 0, zIndex: 100, display: "flex", alignItems: "center", gap: 14 }}>
        ...
        <span style={{ fontSize: 11, color: "rgba(255,255,255,0.55)" }}>/ feedback semanal</span>
      </div>
      <div style={{ padding: "20px 16px" }}>
        ...
        <div style={{ fontSize: 22, fontWeight: 900, color: "#1C1917", letterSpacing: "-0.02em", marginBottom: 4 }}>⭐ feedback semanal</div>
        <div style={{ fontSize: 13, color: "rgba(28,25,23,0.5)", marginBottom: 20, lineHeight: 1.5 }}>todo sábado o aluno avalia a semana e o Cria gera o relatório automático</div>
